...
def run_pdf_parser(repo_root: Path, entry: Entry, *, adaptive: bool, config: PdfParserConfig) -> dict[str, object]:
    ...
    return row(
        ...
        metrics={
            ...
            "table_bbox_iou": metrics.get("table_bbox_iou"),
            "table_numeric_accuracy": metrics.get("table_numeric_accuracy"),
            "table_header_accuracy": metrics.get("table_header_accuracy"),
            "table_footnote_accuracy": metrics.get("table_footnote_accuracy"),
...
def skipped(entry: Entry, parser: str, reason: str) -> dict[str, object]:
    result = row(
        ...
        metrics={
            ...
            "table_bbox_iou": None,
            "table_numeric_accuracy": None,
            "table_header_accuracy": None,
            "table_footnote_accuracy": None,
    ...
    for data in rows:
        ...
        body.append(
            (
                ...
                fmt(metrics.get("table_bbox_iou")),
                fmt(metrics.get("table_numeric_accuracy")),
                fmt(metrics.get("table_header_accuracy")),
                fmt(metrics.get("table_footnote_accuracy")),
